...
namespace NCMB
{
    ...
    public class NCMBSettings : MonoBehaviour
	{
        ...
        /// シングルトン化
        /// </summary>
        private static NCMBSettings instance = null;
        public static NCMBSettings Instance {
            get
            {
                if (instance == null)
                {
                    instance = FindObjectOfType<NCMBSettings>();

                    if (instance == null)
                    {
                        instance = new GameObject("NCMBSettings").AddComponent<NCMBSettings>();
                    }
                }
                return instance;
            }
